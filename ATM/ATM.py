...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent,bg='#ff4d4d')
        ...
        heading_label = tk.Label(self,text='ITI ATM',font=('orbitron',45,'bold'),
                                 foreground='white',background='#ff4d4d')
        heading_label.pack(pady=25)

		
        space_label = tk.Label(self,height=4,bg='#ff4d4d')
        space_label.pack()

        password_label = tk.Label(self, text='Enter your password',
                                  font=('orbitron',13),bg='white',fg='black')
        ...
        incorrect_password_label = tk.Label(self,text='',font=('orbitron',13),
                                            fg='white',bg='#ff3333',anchor='n')
...
class MenuPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        heading_label = tk.Label(self,text='ITI ATM',
                                 font=('orbitron',45,'bold'),
                                 foreground='white',background='#ff4d4d')
								 
        heading_label.pack(pady=25)

        main_menu_label = tk.Label(self,text='Main Menu',font=('orbitron',13),
									fg='white',bg='#ff4d4d')
									
        main_menu_label.pack()

        selection_label = tk.Label(self,text='Please make a selection',
                                   font=('orbitron',13),fg='white',
                                    bg='#ff4d4d',anchor='w')
									
        selection_label.pack(fill='x')

        button_frame = tk.Frame(self,bg='#ff3333')
        ...
        balance_button = tk.Button(button_frame,text='Balance',
                                   command=balance,relief='raised',
                                   borderwidth=3,width=50,height=5)
								   
        balance_button.grid(row=0,column=1,pady=20,padx=800)
        ...
        exit_button.grid(row=1,column=1,pady=20,padx=800)
...
class WithdrawPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        heading_label = tk.Label(self,text='ITI ATM',
                                 font=('orbitron',45,'bold'),
                                 foreground='#ffffff',background='#ff4d4d')
								 
        heading_label.pack(pady=25)

        choose_amount_label = tk.Label(self,text='Choose the amount you want to withdraw',
                                       font=('orbitron',13),fg='white',bg='#ff4d4d')
        ...
        fifty_button = tk.Button(button_frame,text='50',command=lambda:withdraw(50),
                                  relief='raised',borderwidth=3,width=50,height=5)
								  
        fifty_button.grid(row=0,column=0,pady=5)

        hundred_button = tk.Button(button_frame,text='100',command=lambda:withdraw(100),
                                   relief='raised',borderwidth=3,width=50,height=5)
        ...
        five_hundred_button = tk.Button(button_frame,text='500',command=lambda:withdraw(500),
                                        relief='raised',borderwidth=3,width=50,height=5)
										
        five_hundred_button.grid(row=3,column=0,pady=5)

        thousand_button = tk.Button(button_frame,text='1000',command=lambda:withdraw(1000),
                                    relief='raised',borderwidth=3,width=50,height=5)
									
        thousand_button.grid(row=0,column=1,pady=5,padx=800)

        two_thousand_button = tk.Button(button_frame,text='2000',command=lambda:withdraw(2000),
                                        relief='raised',borderwidth=3,width=50,height=5)
										
        two_thousand_button.grid(row=1,column=1,pady=5)

        five_thousand_button = tk.Button(button_frame,text='5000',command=lambda:withdraw(5000),
                                         relief='raised',borderwidth=3,width=50,height=5)
										 
        five_thousand_button.grid(row=2,column=1,pady=5)

        cash = tk.StringVar()
        other_amount_entry = tk.Entry(button_frame,textvariable=cash,
                                      width=59,justify='right')
...
class DepositPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        enter_amount_label = tk.Label(self, text='Enter amount',
                                      font=('orbitron',13),bg='#ff4d4d',fg='white')
        ...
        two_tone_label = tk.Label(self,bg='#ff3333')
